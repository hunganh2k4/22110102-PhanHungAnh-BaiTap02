...
import User from '../models/user'; //import database
...
let getHomePage = async (req, res) => {
    ...
    try {
        let data = await User.find({}); //lấy dữ liệu từ models
        console.log('......');
        console.log(data);
        console.log('......');
...
} //goi view và truyền dữ liệu ra view

//hàm post CRUD
let postCRUD = async (req, res) => { //dùng async để xử lý bất động bộ
...
let deleteCRUD = async (req, res) => {
    let id = req.query.id; //vi trên view hid=1
    if(id){
